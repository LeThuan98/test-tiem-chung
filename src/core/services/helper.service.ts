...
export class HelperService {
    ...
    encryptRes(request, data: Object, timestamp: string) {
        ...
        return data;
        // let prefixPath = process.env.BASE_PATH ? `${process.env.BASE_PATH}/api/v1` : 'api/v1';
    ...
    async hash(plaintext: string, hash: number = 2): Promise<string> {
