...
module.exports = exports = function updatedAtPlugin(schema, options) {
    ...
    schema.methods.thumbTrans = function (
        field: string,
        type: string,
        locale?: string,
    ): string | object {
    ...
    schema.methods.downloadThumb = async function (
        res: any,
        field: string,
        type: string,
    ): Promise<any> {
        if (typeof this.thumbnail === 'function') {
            ...
            if (!this[field]) {
                ...
                return helperFile.downloadThumb(
                    res,
                    this,
                    field,
                    thumbnail['collection'],
